 ...
 * @author boc
 */
@WebServlet(name = "TransactionTypeEditController", urlPatterns = {"/TransactionTypeEditController"})
public class TransactionTypeEditController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        PrintWriter out = response.getWriter();
         try {
            ...
            TblTransactiontype add_obj= acs.searchTransactionstype(id);
