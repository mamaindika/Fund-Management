 ...
 * @author Boc
 */
@WebServlet(name = "editMasterAccountsController ", urlPatterns = {"/editMasterAccountsController "})
public class editMasterAccountsController extends HttpServlet {
      ...
      protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         try {
            ...
            TblMasteraccounts add_obj= acs.searchAccount(id);
            RequestDispatcher rd =request.getRequestDispatcher("editMasterAccountsPage.jsp"); 
