 ...
 * @author Boc
 */
@WebServlet(name = "updateMasterAccountsController", urlPatterns = {"/updateMasterAccountsController"})
public class updateMasterAccountsController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
           ...
           int fundtype= (Integer)request.getSession().getAttribute("loggedFundType");
            ...
            String resultMessage = acs.updateMasterAccounts(ac);
            TblMasteraccounts add_obj= acs.searchAccount(accountNo);
