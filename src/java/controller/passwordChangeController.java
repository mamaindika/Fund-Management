...
public class passwordChangeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
            ...
            TblUsercredentials user = new TblUsercredentials(userId, ac, encryptPassword(password),1,0);
            loginService ud = new loginService();
            ud.updateUserCreDetails(user);
            

           request.setAttribute("errorMessage", "Your password has been changed successfully");
