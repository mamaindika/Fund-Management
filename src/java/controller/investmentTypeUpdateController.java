...
public class investmentTypeUpdateController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       try {
            ...
            InvestmentTypesService er = new InvestmentTypesService();
            TblInvestmenttypes obj_usr = er.searchAccount(id);
            request.setAttribute("searchResult", obj_usr);
            request.setAttribute("errorMessage", "Investment type has been defined already ");
            RequestDispatcher rd = request.getRequestDispatcher("InvestmentType_EditPage.jsp");
            rd.forward(request, response);
        }
    }
