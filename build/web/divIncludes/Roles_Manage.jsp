...
<!--                    <a href="UserRole_DeletePage.jsp?id=<%=us.getId()%>" class="btn btn-primary btn-xs custom">Delete</a>-->
...
<form  method="post"  action="userRolesAddController" name="adduserRole" onsubmit="return formValidation()"   class="form-horizontal" style="width:800px">
 
                        <!-- Form Name -->
                        <legend style="width: 550px;"><h4 style="text-align: left;"><b>ADD NEW USER ROLE</b></h4></legend>
...
<!--            <span class="col-md-1 form_errorMsg" id="msg1"><code>Invaild</code></span>-->
        </div>
         ...
         <div class="form-group">
            <div class="col-md-5">
                ...
                <div style="padding-left:220px;">
                    ...
                    &nbsp;
                    <a href="UserRole_ManagePage.jsp"  class="btn btn-primary btn-sm custom">BACK</a>          
                 </div>
            </div>
        </div>  
...
$(document).ready(function() { 
 ...
 $("#submit").click(
	...
	function formValidation(){
            ...
            var description = document.adduserRole.description;
