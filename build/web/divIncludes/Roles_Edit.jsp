...
.custom {width: 50px !important;}
    ...
    <form id="togglingForm" name="editUserRoles" onsubmit="return formValidation()" class="form-horizontal" style="width:800px" method="post" action="userRolesUpdateController">
        ...
        <!-- Form Name -->
        <legend><h4 style="text-align: left;"><b>EDIT USER ROLE</b></h4></legend>
  ...
  <div class="btn">
                       ...
                       <div style="padding-left:0px">
                          ...
                          <input id="submit" type="submit" class="btn btn-primary btn-sm" value="UPDATE"/>
                            &nbsp;
                             <a href="UserRole_ManagePage.jsp"   class="btn btn-primary btn-sm">BACK</a>
                                   </div>
                       </div>
</div> 
...
<h3 style="margin-bottom: -48px; margin-left: -230px; font-size: 15px">
<code>
