<%-- 
    Document   : TransactionEdit
    Created on : Jul 27, 2016, 4:25:07 PM
    Author     : boc
--%>
...
%>
<form  method="post" class="form-horizontal" action="TransactionUpdateController">
<!-- Form Name -->
...
<div class="form-group" hidden="true">
    <label class="col-md-2 control-label"  style="text-align:left">created Date</label> 
        <div class="col-md-3">
...
<div class="form-group" hidden="true">
    <label class="col-md-2 control-label"  style="text-align:left">Created User</label> 
        <div class="col-md-3">
...
<a href="TransactionManagePage.jsp"  class="btn btn-xs custom btn-primary">Back</a>
