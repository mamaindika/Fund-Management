...
<form id="togglingForm"  method="post" name="addFundType"  onsubmit="return formValidation()" action="fundTypeAddController"  class="form-horizontal" style="width:800px">
                        ...
                        <!-- Form Name -->
                        <legend style="width: 550px;"><h4 style="text-align: left;"><b>ADD NEW FUND TYPE</b></h4></legend>
         ...
         <div class="form-group">
            <div class="col-md-5">
                ...
                <div style="padding-left:220px;">
                    ...
                    &nbsp;
                    <a href="FundType_ManagePage.jsp"  class="btn btn-primary btn-sm custom">BACK</a>          
                 </div>
            </div>
        </div> 
