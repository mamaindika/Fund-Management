...
%>
    ...
    <h3 class="panel-title" style="color:white; text-align: left; padding-left:0px"><b>SIGN IN</b></h3>
    </div>
    <div class="panel-body" style="background-color:#86c5da">				
    <form  class="form-horizontal" name="loginForm" onsubmit="return validateform()" action="loginController"  method="post">
    <div class="form-group">
    <label class="col-md-4 control-label" for="User Name" style="text-align:left;  font-size:12px; color: black">USERNAME</label> 
    <div class="col-md-6">
    <input id="userId" name="userId" type="text"  class="form-control input-sm" style="padding-left:10px">
    </div>
    </div>
    <div class="form-group">
    <label class="col-md-4 control-label" for="InputPassword" style="text-align:left;  font-size:12px; color: black">PASSWORD</label> 
    <div class="col-md-6">
        <input id="password" name="password"  type="password"  class="form-control input-sm" style="padding-left:10px">
    ...
    <div id="footer" style="background-color: navy; margin-top:-3px;">
