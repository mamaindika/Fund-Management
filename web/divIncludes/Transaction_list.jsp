            ...
            <tbody style="text-align:left">
                <%
                    ...
                    for (Iterator iterator = users.iterator(); iterator.hasNext();) {
                        ...
                        if((us.getStatus().equals("Authorized")||us.getStatus().equals("Rejected"))&&(us.getTblFundtypes().getId().equals(session.getAttribute("loggedFundType")))  ){
                %>
                <tr>
                    <td style="text-align:left; color: black"><%= us.getTransactionDescription()%></td>
                    <td style="text-align:left;  color: black"><%= us.getTblTransactiontype().getTransactionDescription()%></td>
                    <td  style="text-align:left; color: black"><%= us.getTransactionAmount()%></td>
                    <td style="text-align:left; color: black"><%= us.getStatus() %></td>
                    <td style="text-align:left; color: black"><%= us.getCreatedUser()%></td>
