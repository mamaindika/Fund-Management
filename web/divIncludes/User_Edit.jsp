...
.custom {width: 50px !important;}
    ...
    <form   class="form-horizontal" method="post" action="userUpdateController" name="userUpdate" onsubmit="return formValidation()">
        ...
        <!-- Form Name -->
        <legend><h4 style="text-align: left;"><b>EDIT USER</b></h4></legend>
        <div class="form-group">
          ...
          <div class="form-group">
                            <label class="col-md-2 control-label"  style="text-align:left; font-size:12px; color: black" >SALUTATIONS</label>
                            <div class="col-md-3">
     ...
     <div class="form-group">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
            <select class="form-control input-sm" id="status"   value=" <% out.println(acc.getStatus()); %>" name="status">
     ...
     <option>In-Active </option>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input id="officeNo" name="officeNo" value="<% out.println(acc.getOfficeNo()); %>" type="text"  class="form-control input-sm">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input id="mobileNo" name="mobileNo" type="text" value="<% out.println(acc.getMobileNo()); %>"  class="form-control input-sm" >
            </div>
