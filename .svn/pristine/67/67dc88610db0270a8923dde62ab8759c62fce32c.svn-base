...
@WebServlet(name = "TransactionEditController", urlPatterns = {"/TransactionEditController"})
public class TransactionEditController extends HttpServlet {
   ...
   protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            int journalId=Integer.parseInt(request.getParameter("searchValue1"));
            int Tid=Integer.parseInt(request.getParameter("searchValue2"));
            ...
            RequestDispatcher rd =request.getRequestDispatcher("TransactionEditPage.jsp");
            System.out.println("AuthorizationEditController"); 
